...
export default function JobDetailsClient({ job, slug }: JobDetailsClientProps) {
  ...
  return (
    <div className="space-y-8 pt-10">
      ...
      {/* Sticky Job Header */}
      <div
        className={`fixed top-0 left-0 right-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm z-50 transform transition-transform duration-300 ${

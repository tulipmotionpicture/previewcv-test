...
export default function ResumesPage() {
    ...
    const [shareLinks, setShareLinks] = useState<Record<number, { link: string; qr: string }>>({});
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-40">
                <div className="flex items-center gap-4">
                    <button onClick={() => router.push('/candidate/dashboard')} className="text-gray-400 hover:text-gray-600">
                        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                        </svg>
                    </button>
                    <Image src={config.app.logoUrl} alt={config.app.name} width={48} height={48} className="rounded-xl" />
            ...
            <div className="max-w-7xl mx-auto p-8">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-2">Failed to load resumes</h3>
...
function ResumeCard({ resume, shareLink, onGetShareLink, onCopyLink, onDownload, onDelete }: ResumeCardProps) {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-all">
            ...
            {/* Resume Info */}
            <h3 className="font-bold text-lg text-gray-900 mb-1 truncate">{resume.resume_name}</h3>
            ...
            {shareLink && (
                <div className="mb-4 p-4 bg-blue-50 rounded-2xl">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-xs font-bold text-blue-600 uppercase">Share Link</span>
                        <button

  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* <DashboardHeader applicationCount={applications.length} /> */}
        ...
        <main className="flex-1 p-8 max-w-7xl w-full mx-auto">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="mb-8 flex justify-between items-center">
                ...
                <div className="relative max-w-md w-full">
                  <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 z-9" />
                  <input
                    type="text"
                    placeholder="Search job"
                    className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 dark:border-gray-800 rounded-2xl"
                  />
                </div>
              </div>
          ...
          {activeTab === "resumes" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 mt-8">

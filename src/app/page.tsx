  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 dark:text-gray-100 transition-colors duration-300">
      ...
      <Header 
        ...
        cta={{ label: 'Recruiter Login', href: '/recruiter/login', variant: 'primary' }}
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all relative z-10">
                ...
                <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100 mb-4 text-center uppercase tracking-tight">Create Resume</h3>
                <p className="text-gray-500 dark:text-gray-400 text-center font-medium leading-relaxed">Build your professional resume on <span className="font-bold text-gray-900 dark:text-white">LetsMakeCV.com</span> with our easy-to-use builder</p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white p-10 rounded-[40px] border border-gray-100 shadow-sm hover:shadow-xl transition-all relative z-10">
                ...
                <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100 mb-4 text-center uppercase tracking-tight">Get Your Link</h3>
                <p className="text-gray-500 text-center font-medium leading-relaxed">Receive your unique <span className="font-bold text-gray-900 dark:text-gray-100">PreviewCV link</span> automatically - same login on both platforms</p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-900 p-10 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all relative z-10">
                ...
                <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100 mb-4 text-center uppercase tracking-tight">Share & Track</h3>
      ...
      <section className="py-32 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-black text-gray-900 dark:text-gray-100 mb-6 tracking-tighter uppercase">Why <span className="italic text-indigo-600">PreviewCV?</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-blue-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">No More PDFs</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-indigo-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">Always Up-to-Date</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-blue-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">Track Views</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-indigo-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">Mobile Optimized</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-blue-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">Secure & Private</h4>
            ...
            <div className="bg-gray-50 dark:bg-gray-950 p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 hover:border-indigo-200 transition-all">
              ...
              <h4 className="text-xl font-black text-gray-900 dark:text-gray-100 mb-3 uppercase tracking-tight">Instant Loading</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white dark:bg-gray-900 rounded-full shadow-sm border border-gray-100 dark:border-gray-800 mb-8">
              ...
              <span className="text-sm font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">Trusted by Professionals</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-gray-100 mb-6 tracking-tighter uppercase">Join Thousands of <span className="italic text-blue-600">Happy Users</span></h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-black text-gray-900 dark:text-gray-100 text-sm uppercase tracking-tight">Sarah Chen</p>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-black text-gray-900 dark:text-gray-100 text-sm uppercase tracking-tight">Michael Torres</p>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-black text-gray-900 dark:text-gray-100 text-sm uppercase tracking-tight">Priya Patel</p>
      ...
      <section className="py-24 bg-white dark:bg-gray-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-gray-900 dark:text-gray-100 tracking-tight mb-4 italic uppercase">Direct Market Pulse</h2>
            ...
            <div className="bg-blue-50/50 rounded-[40px] p-8 border border-blue-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="bg-white dark:bg-gray-900 p-5 rounded-3xl border border-blue-100 shadow-sm hover:shadow-md transition-all group">
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-bold text-gray-900 dark:text-gray-100 uppercase text-sm tracking-tight">{job.title}</h4>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative">
                        <span className="text-sm font-black text-gray-900 dark:text-gray-100 blur-[4px] select-none">{job.salary}</span>
            ...
            <div className="bg-indigo-50/50 rounded-[40px] p-8 border border-indigo-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="bg-white dark:bg-gray-900 p-5 rounded-3xl border border-indigo-100 shadow-sm hover:shadow-md transition-all">
                    <div className="flex items-center gap-4 mb-3">
                      ...
                      <div>
                        ...
                        <h4 className="font-bold text-gray-900 dark:text-gray-100 text-xs uppercase tracking-tight">{can.role}</h4>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex gap-2">
                        {can.skills.map(s => <span key={s} className="text-[10px] bg-gray-50 dark:bg-gray-950 text-gray-500 px-2 py-1 rounded-lg border border-gray-100 dark:border-gray-800 font-black uppercase tracking-tighter">{s}</span>)}
                      </div>
      ...
      <section className="py-32 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl lg:text-6xl font-black text-gray-900 dark:text-gray-100 mb-6 tracking-tighter uppercase">Frequently Asked <span className="italic text-indigo-600">Questions</span></h2>
          ...
          <div className="space-y-6">
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">Is PreviewCV free to use?</h3>
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">Do I need a LetsMakeCV account?</h3>
                <svg className="w-6 h-6 text-gray-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">How do I get my PreviewCV link?</h3>
                <svg className="w-6 h-6 text-gray-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">What happens when I update my resume?</h3>
                <svg className="w-6 h-6 text-gray-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">Is my data secure?</h3>
                <svg className="w-6 h-6 text-gray-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group bg-gray-50 dark:bg-gray-950 rounded-[32px] border border-gray-100 dark:border-gray-800 overflow-hidden hover:border-blue-200 transition-all">
              <summary className="flex items-center justify-between p-8 cursor-pointer list-none">
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">Can I track who views my resume?</h3>
                <svg className="w-6 h-6 text-gray-400 group-open:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>

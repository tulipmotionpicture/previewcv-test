      ...
      <div className="bg-blue-600 px-6 py-2 flex items-center justify-between">
        ...
        {Object.values(selectedFilters).some((arr) => arr.length > 0) ? (
          <button
            ...
            className="text-xs text-white opacity-90 hover:opacity-100 hover:underline font-medium flex items-center gap-1"
          >
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
            Clear
          </button>
        ) : (
          <button className="text-white opacity-0 cursor-default">

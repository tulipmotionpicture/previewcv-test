...
export default function DashboardSidebar<T extends string>({
  ...
  return (
    <aside
      className={`w-62 min-h-screen p-6 sticky top-0 h-screen flex flex-col transition-colors duration-200 ${
        isDark
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg transition-all duration-150 text-sm flex items-center ${
                showChevron ? "justify-between" : "gap-3"

...
function RecruiterResetPasswordInner() {
...
/**
 * Recruiter "set a new password" form. Reads the reset `token` from the URL
 * query, validates the new password, and calls
 * POST /api/v1/recruiters/auth/password-reset/confirm via api.recruiterPasswordConfirm.
 * Rendered at both /recruiter/auth/reset-password (the route the backend emails)
 * and the legacy /recruiter/confirm-password route.
 */

...
export default function CreateJobModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <form onSubmit={onSubmit} className="relative w-full max-w-4xl bg-white dark:bg-[#1E1E1E] rounded-xl shadow-2xl flex flex-col max-h-[90vh]">
                {/* Header */}
                <div className="flex items-center justify-between px-6 py-4 bg-[#0B172B] rounded-t-xl border-b border-gray-800">
                    <h2 className="text-lg font-semibold text-white">Post New Opportunity</h2>
                    <button
                        type="button"
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const event = {
                                            target: { name: "is_remote", type: "checkbox", checked: isRemote, value: isRemote }
                                        } as any;
                                        onChange(event);
                                    }}
                                    className="w-full appearance-none px-4 py-2.5 bg-white dark:bg-[#282727] border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none transition-all dark:text-white pr-8"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            ...
                            {jobForm.categories.split(",").filter(c => c.trim()).map((cat, i) => (
                                <span key={i} className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium">
                                    {cat.trim()}

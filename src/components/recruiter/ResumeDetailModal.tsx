...
export default function ResumeDetailModal({
  ...
  if (isLocked) {
    return (
      <MaximizableModal
        ...
        title="Resume Locked"
        headerIcon={<Lock className="w-5 h-5" />}
        maxWidthClass="max-w-2xl"
        footer={(hasPrevious || hasNext) && (
  ...
  return (
    <MaximizableModal
      ...
      title={<span>Resume Details - {resumeData.resume_name}</span>}
      headerIcon={<Download className="w-5 h-5" />}
      footer={
    ...
    >
      <div className="space-y-6">
        ...
        {resumeData.resume_data?.sections?.workExperience &&
          resumeData.resume_data.sections.workExperience.length > 0 && (
            <div>
        ...
        {resumeData.resume_data?.sections?.certifications &&
          resumeData.resume_data.sections.certifications.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2">
        ...
        {resumeData.resume_data?.sections?.accomplishments &&
          resumeData.resume_data.sections.accomplishments.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Accomplishments
              </h4>
        ...
        {resumeData.resume_data?.sections?.volunteering &&
          resumeData.resume_data.sections.volunteering.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Volunteering
              </h4>
        ...
        {resumeData.resume_data?.sections?.internships &&
          resumeData.resume_data.sections.internships.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Internships
              </h4>
        ...
        {resumeData.resume_data?.sections?.publications &&
          resumeData.resume_data.sections.publications.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Publications
              </h4>
        ...
        {resumeData.resume_data?.sections?.socialMedia &&
          resumeData.resume_data.sections.socialMedia.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Social Media
              </h4>
        ...
        {resumeData.resume_data?.sections?.affiliations &&
          resumeData.resume_data.sections.affiliations.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                Affiliations
              </h4>
        ...
        {resumeData.resume_data?.personalInfo && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
              ...
              {resumeData.resume_data.personalInfo.professionalTitle && (
                <div>
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Professional Title
                  </span>
              ...
              {resumeData.resume_data.personalInfo.postalZipCode && (
                <div>
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Postal/ZIP Code
                  </span>
              ...
              {resumeData.resume_data.personalInfo.profileDescription && (
                <div className="col-span-2">
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Profile Description
                  </span>
        ...
        {resumeData.resume_data?.sections?.customSections &&
          resumeData.resume_data.sections.customSections.length > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">

                            ...
                            {jobs.map((job) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100 group-hover:text-primary-blue dark:group-hover:text-blue-400 truncate transition-colors leading-tight mb-1">
                                            {job.title}
                                        </h3>

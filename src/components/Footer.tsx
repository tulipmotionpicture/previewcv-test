      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="pt-8 border-t border-gray-300 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            © {new Date().getFullYear()} PreviewCV. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link
              ...
              className="text-gray-600 dark:text-gray-400 hover:text-teal-dark dark:hover:text-mint transition-colors"
            >
